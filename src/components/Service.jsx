...
const Service = () => {
    ...
    useEffect(() => {
        fetch('https://mern-server-qaucfs3ij-dipongkarroy233-gmailcom.vercel.app/services')
            .then(res => res.json())
    ...
    return (
        <div className="mt-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 lg:gap-5 px-8 md:px-24 lg:px-4 mt-5">
                {
